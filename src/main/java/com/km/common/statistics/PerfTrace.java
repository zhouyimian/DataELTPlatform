package com.km.common.statistics;


import com.km.common.util.Configuration;
import com.km.common.util.HostUtils;
import com.km.common.statistics.PerfRecord.PHASE;
...
public class PerfTrace {
    ...
    private synchronized String summarize() {
        ...
        Collections.sort(keys, new Comparator<PHASE>() {
            @Override
            public int compare(PerfRecord.PHASE o1, PHASE o2) {
