                ...
                for (int i = 1; i <= columnNumber; i++) {
                    ...
                    switch (metaData.getColumnType(i)) {
                        ...
                        case Types.LONGNVARCHAR:
                            ...
                            record.addColumn(new StringColumn(rawData,columnName));
                            break;

                        case Types.CLOB:
                        case Types.NCLOB:
                            record.addColumn(new StringColumn(rs.getString(i),columnName));
                            break;
                        ...
                        case Types.INTEGER:
                        case Types.BIGINT:
                            record.addColumn(new LongColumn(rs.getString(i),columnName));
                            break;

                        case Types.NUMERIC:
                        case Types.DECIMAL:
                            record.addColumn(new DoubleColumn(rs.getString(i),columnName));
                            break;
                        ...
                        case Types.TIME:
                            record.addColumn(new DateColumn(rs.getTime(i),columnName));
                            break;

                        // for mysql bug, see http://bugs.mysql.com/bug.php?id=35115
                        case Types.DATE:
                            if (metaData.getColumnTypeName(i).equalsIgnoreCase("year")) {
                                record.addColumn(new LongColumn(rs.getInt(i),columnName));
                            } else {
                                record.addColumn(new DateColumn(rs.getDate(i),columnName));
                            }
                            break;

                        case Types.TIMESTAMP:
                            record.addColumn(new DateColumn(rs.getTimestamp(i),columnName));
                            break;
                        ...
                        case Types.LONGVARBINARY:
                            record.addColumn(new BytesColumn(rs.getBytes(i),columnName));
                            break;
                        ...
                        case Types.BOOLEAN:
                        case Types.BIT:
                            record.addColumn(new BoolColumn(rs.getBoolean(i),columnName));
                            break;
                        ...
                        case Types.NULL:
                            ...
                            record.addColumn(new StringColumn(stringData,columnName));
                            break;
