package com.km.data.core.util.container;
...
public class CoreConstant {
	...
	public static final String DATAX_JOB_CONTENT_READER_NAME = "job.content.reader.name";

	public static final String DATAX_JOB_CONTENT_READER_PARAMETER = "job.content.reader.parameter";

	public static final String DATAX_JOB_CONTENT_WRITER_NAME = "job.content.writer.name";

	public static final String DATAX_JOB_CONTENT_WRITER_PARAMETER = "job.content.writer.parameter";

    public static final String DATAX_JOB_CONTENT_ETL = "job.content.ETL";
	...
	public static final String DATAX_JOB_CONTENT_TRANSFORMER = "job.content.transformer";
	...
	public static String DATAX_CONF_PATH = StringUtils.join(new String[] {
			DATAX_HOME, "conf", "static/core.json"}, File.separator);
...
//    public static String DATAX_PLUGIN_READER_HOME = "E:\\IDEA_project\\DataX-master\\mysqlreader\\target\\datax\\plugin\\reader\\mysqlreader\\plugin.json";
//
//    public static String DATAX_PLUGIN_WRITER_HOME = "E:\\IDEA_project\\DataX-master\\streamwriter\\target\\classes\\plugin.json";
