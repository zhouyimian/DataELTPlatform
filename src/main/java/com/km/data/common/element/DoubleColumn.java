...
public class DoubleColumn extends Column {
    ...
    public DoubleColumn(final String data, String columnName) {
        this(data, null == data ? 0 : data.length(), columnName);
        this.validate(data);
    }
    ...
    public DoubleColumn(Long data, String columnName) {
        this(data == null ? (String) null : String.valueOf(data), columnName);
    }
    ...
    public DoubleColumn(Integer data, String columnName) {
        this(data == null ? (String) null : String.valueOf(data), columnName);
    }
    ...
    public DoubleColumn(final Double data, String columnName) {
        this(data == null ? (String) null
                : new BigDecimal(String.valueOf(data)).toPlainString(), columnName);
    }
    ...
    public DoubleColumn(final Float data, String columnName) {
        this(data == null ? (String) null
                : new BigDecimal(String.valueOf(data)).toPlainString(), columnName);
    }
    ...
    public DoubleColumn(final BigDecimal data, String columnName) {
        this(null == data ? (String) null : data.toPlainString(), columnName);
    }
    ...
    public DoubleColumn(final BigInteger data, String columnName) {
        this(null == data ? (String) null : data.toString(), columnName);
    }
    ...
    private DoubleColumn(final String data, int byteSize, String columnName) {
        super(data, Column.Type.DOUBLE, byteSize, columnName);
    }
