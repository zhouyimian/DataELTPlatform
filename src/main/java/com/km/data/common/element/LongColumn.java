...
public class LongColumn extends Column {
    ...
    public LongColumn(final String data,String columnName) {
        super(null, Column.Type.LONG, 0);
        if (null == data) {
            return;
        }
    ...
    public LongColumn(Long data,String columnName) {
        this(null == data ? (BigInteger) null : BigInteger.valueOf(data),columnName);
    }
    ...
    public LongColumn(BigInteger data,String columnName) {
		this(data, null == data ? 0 : 8,columnName);
	}
    ...
    private LongColumn(BigInteger data, int byteSize,String columnName) {
        super(data, Column.Type.LONG, byteSize,columnName);
    }
